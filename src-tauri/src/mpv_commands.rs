...
use crate::mpv_core::{dll_candidates, MpvCore, RenderBackend};
use crate::mpv_d3d11_backend::D3D11Backend;
...
pub fn mpv_init(app: AppHandle, core: State<MpvCore>) -> Result<(), String> {
  ...
  core
    .init(candidates, backend, hwnd, move || {
...
pub fn mpv_load_file(
  ...
  if core.backend_state() == crate::mpv_core::BackendState::Uninitialized {
...
#[tauri::command]
pub fn mpv_resize(core: State<MpvCore>, x: i32, y: i32, width: u32, height: u32) -> Result<(), String> {
