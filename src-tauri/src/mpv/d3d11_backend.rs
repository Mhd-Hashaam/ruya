...
use crate::mpv::core::{MpvApi, MpvCoreError, RenderBackend};
...
impl RenderBackend for D3D11Backend {
    ...
    fn init(
        ...
        let parent_hwnd_val = window_hwnd.ok_or(MpvCoreError::RenderInit(
            "Missing HWND for Native backend".into(),
        ))?;
        ...
        unsafe {
            ...
            let class_name = windows::core::w!("RuyaVideoClass");
